...
import com.example.jetnews.resources.ic_cloud_off
import com.example.jetnews.resources.load_error
import com.example.jetnews.resources.load_error_hint
...
fun LoadError(modifier: Modifier = Modifier) {
    BoxWithConstraints(modifier) {
        Column(
            ...
            Text(
                text = stringResource(Res.string.load_error_hint),
