...
You can optionally [configure](http://localhost:63342/storyblok-kotlin/build/dokka/html/ktor-client-plugin/com.storyblok.ktor/-api/-config/-content/index.html) default parameters that are applied to all requests:
